...
define('BOX_TOOLS_IMAGE_HANDLER', '图像管理<sup>4</sup>');
...
define('IH_HEADING_TITLE', '图像管理<sup>4</sup>');
...
// image manager
define('IH_IMAGE_NEW_FILE', '点击添加新图片');
define('IH_IMAGE_EDIT', '点击修改图片');
define('TEXT_MEDIUM_FILE_IMAGE', '中图像文件 (可选)');
define('TEXT_LARGE_FILE_IMAGE', '大图像文件 (可选)');

// ih menu
define('IH_MENU_MANAGER', '图像管理');
define('IH_MENU_ADMIN', '管理工具');
define('IH_MENU_ABOUT', '关于/帮助');
define('IH_MENU_PREVIEW', '预览');
