...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', '版权所有 &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. <a target="_blank" href="http://www.zen-cart.cn">Zen Cart</a> templates by <a target="_blank" href="http://www.12leaves.com/store/free-templates/">12leaves</a>');
