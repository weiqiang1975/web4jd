...
define('TEXT_MAIN','如果没有定义模板文件，这里就是该页的简体中文定义语句. 位于: <strong>/includes/languages/schinese/crista_violet/index.php</strong>');

// Showcase vs Store
if (STORE_STATUS == '0') {
  define('TEXT_GREETING_GUEST', '欢迎您 <span class="greetUser">客人!</span> 您可以在这里 <a href="%s">登录</a>?');
} else {
  define('TEXT_GREETING_GUEST', '欢迎您, 请参观我们的网上商店。');
}
...
//define('TABLE_HEADING_NEW_PRODUCTS', '新进商品 - %s');
