...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. <a class="bottom-link" target="_blank" href="http://www.zen-cart.cn">Zen Cart</a> templates by <a class="bottom-link" target="_blank" href="http://www.12leaves.com/store/zen-cart-templates-free/">pixemus</a>');
...
// Column Layout
  define('TEXT_COLUMN_LAYOUT_LIST', 'List');
  define('TEXT_COLUMN_LAYOUT_GRID', 'Grid');
