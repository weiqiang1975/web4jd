...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. <a class="bottom-link" target="_blank" href="http://www.zen-cart.cn">Zen Cart</a> templates by <a class="bottom-link" target="_blank" href="http://www.pixemus.com/">pixemus</a>');
