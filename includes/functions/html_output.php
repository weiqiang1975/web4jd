 ...
 */
  function zen_draw_form($name, $action, $method = 'post', $parameters = '') {
    ...
    if(strtolower($method) == 'post' && $action != 'https://www.alipay.com/cooperate/gateway.do?_input_charset=utf-8') $form .= '<input type="hidden" name="securityToken" value="' . $_SESSION['securityToken'] . '" />';
    return $form;
  }
