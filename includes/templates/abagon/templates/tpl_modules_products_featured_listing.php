...
//            $how_many++;
        ...
        $the_button = $link;
        $products_link = '<span class="more-info"><a href="' . zen_href_link(zen_get_info_page($featured_products->fields['products_id']), 'cPath=' . zen_get_generated_category_path_rev($featured_products->fields['master_categories_id']) . '&products_id=' . $featured_products->fields['products_id']) . '">' . MORE_INFO_TEXT . '</a></span>';
      ...
      if (PRODUCT_FEATURED_LIST_DESCRIPTION > '0') {
        ...
        $display_products_description = stripslashes(zen_trunc_string($disp_text, PRODUCT_FEATURED_LIST_DESCRIPTION, '...<br /><span class="more-info float-right"><a href="' . zen_href_link(zen_get_info_page($featured_products->fields['products_id']), 'cPath=' . zen_get_generated_category_path_rev($featured_products->fields['master_categories_id']) . '&products_id=' . $featured_products->fields['products_id']) . '">' . MORE_INFO_TEXT . '</a></span>'));
      } else {
        $display_products_description = '';
      }
...
?>
		  ...
		  <td>
			...
			<tr>
            <td width="<?php echo IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH + 10; ?>" valign="top" class="listing-img main" align="center">
              <?php
            ...
            <td valign="top" class="main">
              ...
              ?>
			<br>
			<?php if (PRODUCT_FEATURED_LIST_DESCRIPTION > '0') { echo $display_products_description; } ?>
