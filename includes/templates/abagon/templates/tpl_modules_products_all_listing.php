...
?>
		  ...
		  <td>
			...
			<tr>
            <td width="<?php echo IMAGE_PRODUCT_ALL_LISTING_WIDTH + 10; ?>" valign="top" class="listing-img main" align="center">
              <?php
			...
			<?php if (PRODUCT_ALL_LIST_DESCRIPTION > '0') { echo $display_products_description; } ?>
            </td>
			</tr>
			</table>
		  </td>
...
?>
          <tr>
            <td class="main"><?php echo TEXT_NO_ALL_PRODUCTS; ?></td>
          </tr>
<?php
  }
?>
